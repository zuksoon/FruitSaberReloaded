...
public class FruitSpawner : MonoBehaviour {
    ...
    public float LRVariation = 1f;
    public float UDVariation = 0.5f;
    ...
    void SpawnFruit() {
        ...
        // GameObject objectToThrow = Instantiate(randomFruit, transform.position, Random.rotation);
        ...
        //objectToThrow.GetComponent<Rigidbody>().AddForce(new Vector3(Random.Range(-LRVariation, LRVariation), upForce + Random.Range(-UDVariation, UDVariation), -foForce));
    }
}